        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-700 w-16">번호</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-700">제목</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-700 w-24">작성자</th>
                <th className="px-6 py-4 text-center text-sm font-medium text-gray-700 w-32">작성일</th>
              </tr>
            </thead>
              ...
              {recruitments.length === 0 ? (
                ...
                recruitments.map((recruitment, index) => (
                  <tr key={recruitment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-center text-sm text-gray-900">관리자</td>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-gray-200 rounded-lg p-6">
              <div className="mb-4">
                <div className="flex items-center mb-2">
                  <span className="text-2xl font-bold text-gray-700">saramin</span>
                  <div className="w-2 h-2 bg-blue-500 rounded-full ml-1"></div>
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">사람인 공고 지원</h3>
            ...
            <div className="bg-gray-200 rounded-lg p-6">
              <div className="mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">잡코리아 공고 지원</h3>
                <p className="text-sm text-gray-600 mb-4">
            ...
            <div className="bg-gray-200 rounded-lg p-6">
              <div className="mb-4">
                <div className="mb-2">
                  <span className="text-2xl font-bold text-green-600">incruit</span>
                </div>
                <h3 className="text-lg font-semibold text-gray-800 mb-2">인크루트 공고 지원</h3>
                <p className="text-sm text-gray-600 mb-4">
      ...
      {selected && (
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center">
          <div className="bg-white rounded-lg w-11/12 max-w-2xl p-6 shadow-xl relative">
            ...
            <p className="text-sm text-gray-600 mb-6">{formatDate(selected.posted_date)} · 관리자 작성</p>
