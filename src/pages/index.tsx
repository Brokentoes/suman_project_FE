    ...
    <>
      ...
      <section className="relative w-full max-h-[100vh] overflow-hidden justify-center">
        ...
        <div
          ...
          style={{ transform: `translateX(-${current * 100}%)`, width: `${bannerImages.length * 100}%` }}
        >
        ...
        <div className="absolute inset-0 flex flex-col  justify-center text-black z-10">
          <h1 className="text-4xl font-bold mb-4 ml-6">정밀한 기술이 만드는<br />내일의 기업 수만</h1>
          <p className="text-lg text-gray-600 max-w-2xl ml-6">{section1Text.subtitle}</p>
        </div>
        ...
        <section className="min-h-[80vh] flex flex-col bg-gray-50 px-4 py-4">
          <div className="flex justify-between items-center w-full p-2">
            ...
            <button className="cursor-pointer px-4 py-2 bg-blue-500 text-white rounded">CEO인사말</button>
          </div>
          ...
          <h2 className="text-3xl mt-6 font-semibold text-center">산업을 움직이는 기술, 수만</h2>
          <h3 className="text-1xl mt-6 text-center">수만은 2차전지 생산 장비 및 신뢰성 평가 시스템을 설계·제작하는 전문 기업입니다.<br />대전 R&D 센터에서 축적한 기술력과 천안 공장의 생산 인프라를 기반으로, 고객 맞춤형 고신뢰성 솔루션을 제공합니다.</h3>
        </section>
