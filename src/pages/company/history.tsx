    ...
    <Layout>
      ...
      <section className="relative py-20 px-4 md:px-8 bg-[#2A3644] text-white overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
          ...
          <div className="relative flex flex-col justify-center items-center h-full min-h-[300px] md:min-h-auto">
            <img
              src="/images/image_31aa9b.jpg" // Use the new background image with the arrow
              alt="Company Growth Arrow"
              className="absolute inset-0 w-full h-full object-cover object-center"
            />
            <div className="absolute bottom-4 right-4 z-20 text-right text-sm text-white">
              <p className="mb-1">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0 opacity-20 text-white text-5xl font-extrabold whitespace-nowrap hidden md:block">
          Company Growth
        </div>
      </section>
      ...
      <div className="content-wrapper">
        ...
        <section className="main-history-timeline py-20 px-4 md:px-8 bg-white">
          <div className="max-w-7xl mx-auto text-left">
            ...
            <h2 className="text-3xl font-bold text-black mb-20">연혁</h2>
            {/* 타임라인 본문 (선, 항목들)을 별도의 중앙 정렬 컨테이너로 감싸기 */}
            <div className="max-w-5xl mx-auto relative pl-10 md:pl-20">
              {" "}
              {/* 전체 타임라인을 오른쪽으로 이동 */}
              <motion.div
                className="timeline-container relative border-l-2 border-black" // 세로선 기본 설정
              ...
              >
                ...
                >
                  <div className="flex items-center absolute -left-2 top-0">
                    <h3 className="timeline-year text-4xl md:text-5xl font-extrabold text-black bg-white pr-4 z-10 -translate-x-full">
                      2014
                    </h3>
                    {/* 점 제거되었음 */}
                  </div>
                ...
                <motion.div
                  className="timeline-item mb-10 relative ml-[60px] md:ml-[100px]"
                  variants={timelineItemVariants}
                >
                ...
                <div className="ml-[100px] md:ml-[140px] mb-2">
                  <motion.p
