...
// --- Start: Dummy homeContentKor structure (replace with actual import in your project) ---
...
// --- End: Dummy homeContentKor structure ---
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <section className="relative z-30 bg-white py-20 px-6">
          {/*상단 라벨 */}
          <motion.div
          ...
          {/* Moved "전체 업적 현황" button here */}
          <motion.div
            className="w-full flex justify-end mt-10 px-8 md:px-[120px]" // Adjusted class for right alignment and spacing
          ...
          <motion.div
            className="px-4 sm:px-6 lg:px-[120px] flex flex-col items-end gap-2 mt-6" // Adjusted margin-top as needed
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 1 }}
            viewport={{ once: true }}
