  ...
  return (
    <Layout>
      ...
      <HeroSection // Use the HeroSection component
        title="CEO 인사말" // Set the title for the CEO page
        subtitle="CEO Message" // Add a subtitle if desired, consistent with org.tsx
        backgroundImage="/images/company_hero.png" // Use the same background image or a different one
      />
        ...
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center md:items-start space-y-10 md:space-y-0 md:space-x-12">
          ...
          >
            ...
            >
              {/* 실제 CEO 이미지로 교체하세요 */}
              <img
                src="/images/ceo.jpg" // 실제 CEO 이미지 경로로 변경하세요
                alt="SUMAN CEO"
