...
export default function VisionPage() {
  ...
  return (
    <>
      ...
      {/* 상단 비주얼 섹션 - 애니메이션 제거 및 모서리 원상복구 */}
      <section
        className="hero-section relative bg-cover bg-center h-[300px] flex items-center text-white"
        style={{
          backgroundImage: 'url("/images/vision-hero-bg.png")',
          backgroundPosition: "center top",
        }}
      >
        <div className="absolute inset-0 bg-black opacity-60"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">기업 비전</h1>
          <p className="text-lg md:text-xl font-medium">Vision</p>
        </div>
      </section>

      {/* 서브 내비게이션 (Breadcrumb) 섹션 - 애니메이션 없음 */}
      <section className="breadcrumb-section bg-gray-700 py-4 px-4 md:px-8 text-white">
        <div className="max-w-7xl mx-auto">
          <p className="text-md">HOME &gt; 기업 비전</p>
        </div>
      </section>
