  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div className="bg-gray-800 pt-20 pb-[250px] relative z-0 flex justify-center items-center">
        ...
        <motion.div
          className="bg-gray-800 py-20 px-4 md:px-8 text-white rounded-t-xl mt-[-200px] relative z-20 overflow-hidden flex justify-center items-center"
