...
export default function Headerv2() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* 메인 메뉴 영역 */}
        <div className={`max-w-7xl mx-auto px-4 py-4 flex justify-between items-center text-base font-medium ${textColor}`}>
          {/* 로고 */}
          ...
          {/* 메인 메뉴 */}
          <nav className="flex-1 flex justify-center space-x-12 tracking-wide">
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              className="w-full bg-gray z-40"
            >
              <div className="max-w-7xl mx-auto px-4 py-3 flex justify-center space-x-10 text-sm text-black tracking-wide">
